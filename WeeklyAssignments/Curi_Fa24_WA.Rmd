...
```{r}
ggplot(combined_data, aes(x = score, y = num_rel_matches, color = sub_type)) +
...
2. The trend line increases very slightly. It looks like as the REI Score increases, so does the analogy score but very slighly. 
