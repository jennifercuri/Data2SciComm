...
When I ran this I got "[1] 889.8202 879.6184 892.2855 847.5153      NaN      NaN      NaN      NaN". When I first, initialized my mean_reaction_loop, I had c() so I can store the values in here. But I realized I had to set it equal to the length of the vector of the distinct columns so there are no other values. In addition, i added the numeric().
