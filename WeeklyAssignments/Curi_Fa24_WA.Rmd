...
# Initial Loadings (tidyverse and ggist)
...
To make the groaph less misleading I included the jitter plot so that the distribution of answers is visible.   


3. 

```{r}
#Inatalling ggdist library
